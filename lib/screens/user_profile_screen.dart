      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Travel Preferences', style: Theme.of(context).textTheme.titleLarge),
            const SizedBox(height: 16),
            
            if (_homeArea.isNotEmpty) ...[
              Text('Home Area: $_homeArea', style: Theme.of(context).textTheme.bodyLarge),
              const SizedBox(height: 8),
            ],
            
            if (_travelStyle.isNotEmpty) ...[
              Text('Travel Style: $_travelStyle', style: Theme.of(context).textTheme.bodyLarge),
              const SizedBox(height: 8),
            ],
            ...
            if (_savedPlaces.isEmpty)
              const Text('No saved places yet. Start exploring and bookmark your favorites!')
            else
              ListView.builder(
                shrinkWrap: true,
